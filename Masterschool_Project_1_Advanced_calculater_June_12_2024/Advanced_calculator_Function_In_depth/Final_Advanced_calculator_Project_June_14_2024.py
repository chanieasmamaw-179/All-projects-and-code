...
def perform_calculations():
    while True:
        ...
        if another != 'yes':
            print("Thank you for using the calculator. Goodbye © Masterschool, Owner of Software Engineering Section, 2024!")
...
def advanced_calculate():
    ...
    while True:
        text_input = input("Please enter a mathematical expression (e.g., sqrt(25), sin(30), log(10), etc.) or type 'back' to return to basic operations, 'exit' to quit: ").strip().lower()
        if text_input == 'back':
            break
        if text_input == 'exit':
            print("Exiting the program. Goodbye © Masterschool, Owner of Software Engineering Section, 2024!")
...
print("You can use functions like sqrt, sin, cos, tan, log, log10, exp, asin, acos, atan, sinh, cosh, tanh, asinh, acosh, atanh, pi, e")
